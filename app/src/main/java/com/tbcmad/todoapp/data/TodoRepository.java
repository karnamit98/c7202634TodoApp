...
public class TodoRepository {
    ...
    public void deleteAll() { mTodoDAO.deleteAll(); }

    public void deleteCompleted() { mTodoDAO.deleteCompleted(); }

    public ETodo getTodoById(int id){
        return  mTodoDAO.getTodoById(id);
    }

    //public void delTodoByIsCompleted(boolean isCompleted) { new delTodoByIsCompletedAsyncTask(mTodoDAO).execute(isCompleted); }
   // public void deleteCompleted(){new deleteCompletedAsyncTask(mTodoDAO).execute(eTodo);}
